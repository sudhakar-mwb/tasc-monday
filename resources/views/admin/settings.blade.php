...
<main class="px-3 pt-5">
    ...
    <div class="w-100 d-flex flex-column align-items-center p-2">
        <div class="col-md-7 col-lg-8 text-start">
            ...
            <hr>
            <form class="needs-validation" id="general_settings_form" action="{{ route('admin.post.settings') }}"
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="col-sm-12 mb-5">
                            ...
                            <input type="color" class="w-100" name="site_bg" id="site_bg" name="head"
                                value="{{ $settings->site_bg }}" required />
                            @error('head')
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="color" class="w-100" id="button_bg" name="button_bg"
                                value="{{ $settings->button_bg }}" required />
                            @error('button_bg')
                                <small class="text-danger text-start ms-2">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 row mt-3">
                        <div class="col-sm-6">
                            ...
                            <input type="color" class="w-100" id="banner_bg" name="banner_bg"
                                value="{{ $settings->banner_bg }}" required />
                            @error('banner_bg')
                                <small class="text-danger text-start ms-2">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-12">
                        <div class="col-sm-12">
                            ...
                            <input type="color" class="w-100" id="head_title_color" name="head_title_color"
                                value="{{ $settings->head_title_color ?? null }}" required />
                            @error('head_title_color')
                                <small class="text-danger text-start ms-2">{{ $message }}</small>
                            @enderror
                        </div>
                    </div>
                    <div class="col-12">
                        ...
                        <textarea type="text" class="form-control" name="banner_content" id="banner_content"
                            placeholder="Enter the banner text content .">{{ $settings->banner_content }}</textarea>
