                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        <div class="col-sm-12 mb-5">
                            ...
                            <input type="color" class="w-100" name="site_bg" id="site_bg" name="head" value="#e66465" />
                        </div>
                        <div class="col-sm-12">
                            <label for="button_bg" class="form-label">Button background-color&nbsp;<i class="bi bi-pen"></i></label><br>
                            <input type="color" class="w-100" id="button_bg" name="button_bg" value="#00dcff" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 row mt-3">
                        <div class="col-sm-12">
                            ...
                            <input type="color" class="w-100" id="banner_bg" name="banner_bg" value="#5600ff" />
                        </div>
                    </div>
