...
<body>
  @include('bodyscriptgoogle')
    ...
    <div id="notification-banner" style="display:none"
        ...
        <div class="banner-content text-light" style="font-size:1rem;font-weight:400;padding-right:50px;padding-left:50px">
    ...
    <header class="header-bar mb-auto mb-3  w-100" style="background-color:{{ $settings->header_bg ?? null }}">
        <div class="container  h-100 p-3 py-2 mx-auto d-flex align-items-center justify-content-between">
            ...
            <nav
                class="nav nav-masthead justify-content-center align-items-center float-md-end onboarding-text-center onboardig-marginbottom">
    ...
    <div class=" container d-flex flex-column h-100 text-center">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main class="">
                <p class="lead m-2">
                    <a href="#" class="btn btn-lg btn-light text-dark fw-bold border-white bg-white"
                        style="font-size: 26px;font-weight:700;color:#434343">Welcome
                        to</a>
                </p>
                    ...
                    @foreach ($cards as $card)
                        <div class="col-lg-4 d-flex flex-column justify-content-between" style="min-height: 220px">
                            <div>
                                ...
                                <p class="card-desc" style="font-size: 1.1rem;color:#928f8f">
                                    {{ $card['description'] }}</p>
                            </div>
                            <p class="mb-0">
                                <a class="btn btn-secondary btn-gradiant mt-2 hit-loading" href={{ $card['link'] }}>
