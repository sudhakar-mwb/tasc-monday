...
class GovernifyServiceRequestForms extends Model
{
    ...
    protected $fillable = ['name','form_data', 'created_at', 'updated_at', 'deleted_at'];
    ...
    // }
    public function categoryServiceFormMappings()
    {
        return $this->hasMany(CategoryServiceFormMapping::class, 'service_form_id');
    }
}
