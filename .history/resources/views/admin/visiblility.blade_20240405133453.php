...
<main class="px-3 pt-5 ">
    ...
    selectedValues.push(e.params.data); // Add newly selected value
}).on('select2:unselect', function (e) {
    var index = selectedValues.findIndex(function(item) {
        return item.id === e.params.data.id;
    });
    if (index !== -1) {
        selectedValues.splice(index, 1); // Remove unselected value
    }
