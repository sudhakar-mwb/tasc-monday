...
<main class="px-3 pt-5 ">
    ...
    <div class="d-flex w-100 justify-content-center" style="gap:20px">
        ...
        <div title="status visibility manage" style="max-width:550px;width:100%;">
          ...
          <div class="form_wrapper border border-success p-4 primary-shadow">
              <form id="status_view_form" class="text-start text-secondary">
                <h5 class="text-secondary  mb-3 pb-2 border-bottom">Card Columns:</h5>
                <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Top Details column</label>
                  <select id="card-column-1" class="form-select" aria-label="Default select example" required>
                  </select>
              </div>
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Mid Heading column</label>
                <select id="card-column-2" class="form-select" aria-label="Default select example" required>
                </select>
            </div>
         
            <h5 class="text-secondary mt-4 mb-3 pb-2 border-bottom">Status Groups:</h5>
                   @foreach(['Yellow','Green','Grey'] as $color)
                   <div class="mb-3" >
                    <h5 class="p-2 " style="border-radius:20%;border-left:10px solid {{ strtolower($color );}};">Color: {{ $color }}</h3>
