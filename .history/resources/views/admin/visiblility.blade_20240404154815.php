                ...
                <form id="column_view_form" class="text-start ">
                    ...
                    <div class="hiddenstep" class="" id="form-step-2">
                        ...
                        <div class="mb-3" id="icon_inputs-wrapper">
                            ...
                            <a href="https://icons.getbootstrap.com/" target="_blank">Go to icons librery&nbsp;<i class="bi bi-box-arrow-up-right"></i></a>   <ul id="icon_inputs">
                            </ul>
                        </div>
...
<div id="full-loader" class="full-loader d-flex align-items-center justify-content-center" style="display: none !important">
<img src="{{ asset('asset/loading4.gif') }}" alt="" >
</div>
<style>
  .full-loader{
    position: fixed; 
