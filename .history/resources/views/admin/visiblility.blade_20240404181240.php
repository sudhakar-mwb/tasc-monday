                   ...
                   <li>
                    ...
                    <ul style="list-style: none" class="color-section">
                      <li>
                        ...
                        <textarea style="background-color: {{ strtolower($color )}}" current_color="{{ $color  }}" class="form-control color-input" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"></textarea>
