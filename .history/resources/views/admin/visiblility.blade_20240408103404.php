                   ...
                   <div class="mb-3" >
                    ...
                    <ul style="list-style: none" class="color-section">
                      <li>
                        ...
                        <textarea name="{{ $key }}_staus" current_color="{{ $key  }}" class="form-control color-input" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px">{{ $val }}</textarea>
