...
$(document).ready(function () {
	...
	async function fetch_color_group() {
		const res_status = await fetchSavedData("colour-mapping", "");
		status_group = await res_status.json();
		if (status_group) Object.enteries(status_group).forEach((item) => {});
	}
	$(document).ready(function () {
		fetch_color_group();
