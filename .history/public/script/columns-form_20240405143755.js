...
function updateSelectedDisplay(id, arr) {
	...
	arr.forEach(function (item) {
		...
		var removeButton = $(
			'<button type="button" onclick="  e.removeAttribute" class="select2-selection__choice__remove" tabindex="-1" title="Remove item" aria-label="Remove item" aria-describedby="select2-onboarding_columns-container-choice-' +
				item.id +
